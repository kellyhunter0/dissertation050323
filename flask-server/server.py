...
def timestampAPI():
    ...
    return {"timestamp": pd.Series(dataframe.date).to_json(orient='values')}#  this returns as the timestamp rather than the converted datetime. convert this on the front end
