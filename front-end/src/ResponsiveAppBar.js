    ...
    return (
      <CNavbar colorScheme="dark" className="bg-dark" expand="xxl">
        ...
        <CContainer fluid>
          ...
          />
          <COffcanvas id="offcanvasNavbar2" className='bg-dark' placement="end" portal={false} visible={visible} onHide={() => setVisible(false)}>
            <COffcanvasHeader>
              <COffcanvasTitle className='offc-title'>DataViz</COffcanvasTitle>
