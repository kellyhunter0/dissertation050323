...
// logs API values to the backend
  ...
  return (
    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-5 col-md-6 d-flex justify-content-center flex-column" style={{marginTop:"30%"}}>
...
<div className="container-fluid" style={{alignItems:"center", padding:'100px'}}>
 
      <h1 id='home'>{data?data.pageName:"Home"}</h1>
      <Grid container spacing={3} display='flex'  alignItems='center' padding=''>
      <Grid xs="auto">
