...
export const AllPredictLinReg = () => {
    const ref3 =  useRef();
    const [linreg, setLinReg] = useState();

    useEffect(() => {
      d3.csv("/datasets/missing-filled-lr.csv", d3.autoType).then(setLinReg);
    }, []);
...
return (
    ...
    <p>
      Replaced all LPG values with Linear Regression Predictions<br/> File Location:<code>./front-end/src/AllPredictedLpg.js</code> and save to reload. 
    </p>
