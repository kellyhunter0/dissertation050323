...
export function OutlierDataChart(headerRef){
    ...
    useEffect(() => {
      d3.csv("/datasets/outlierremoval.csv", d3.autoType).then(setBigData);
    }, []);
    ...
    return (
      ...
      <header className="App-header" ref={ref}>
        <p>
          Before Outlier Removal <br/> File Location:<code>./front-end/src/OutlierChartGraph.js</code> and save to reload. 
        </p>
